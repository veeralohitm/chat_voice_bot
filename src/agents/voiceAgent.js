...
export function buildVoiceAgent({ accountKey, sessionContext, clientConfig, businessName, onEndCall }) {
  ...
  return new RealtimeAgent({
    ...
    instructions,
    tools: buildVoiceTools({ accountKey, sessionContext, clientConfig, onEndCall }),
  });
}
